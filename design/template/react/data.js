export const announcement = {
  left: "Winter cycle opens Friday at 9am PT",
  right: "Free pickup at 3 drop sites",
};
...
export const hero = {
  ...
  title: "A coastal catalog feel with real farm roots.",
  body:
...
export const categories = [
  { icon: "M", title: "Meat + Poultry", note: "Pasture raised cuts" },
  { icon: "D", title: "Dairy", note: "Milk, butter, cheese" },
  { icon: "E", title: "Eggs", note: "Weekly farm eggs" },
  { icon: "P", title: "Pantry", note: "Grains, honey, herbs" },
];
...
export const products = [
  ...
  },
  {
    ...
    price: "$10.00",
    image:
      "https://images.unsplash.com/photo-1481671703460-040cb8a2d909?auto=format&fit=crop&w=900&q=80",
  },
  {
    name: "Pastured Eggs",
    note: "Dozen",
...
export const recipes = [
  { title: "Sunday pot roast", note: "How to braise with marrow bones and roots." },
  { title: "Weeknight skillet eggs", note: "Pantry staples you already have." },
  { title: "Raw milk yogurt", note: "Simple cultures, low heat, big flavor." },
];
